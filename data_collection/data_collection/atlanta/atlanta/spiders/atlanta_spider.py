...
from atlanta.items import AtlantaItem

#from scrapy.shell import inspect_response

class AtlantaSpider(CrawlSpider):
    name = 'atlanta'
    allowed_domains = ["atlanta.craigslist.org"]
    start_urls = ["http://atlanta.craigslist.org/search/moa?srchType=T&query=iphone"]
    base_url = "http://atlanta.craigslist.org"
    rules = [
