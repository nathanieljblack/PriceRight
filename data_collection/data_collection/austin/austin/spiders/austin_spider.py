...
from austin.items import AustinItem

#from scrapy.shell import inspect_response

class AustinSpider(CrawlSpider):
    name = 'austin'
    allowed_domains = ["austin.craigslist.org"]
    start_urls = ["http://austin.craigslist.org/search/mob?srchType=T&query=iphone"]
    base_url = "http://austin.craigslist.org"
    rules = [
