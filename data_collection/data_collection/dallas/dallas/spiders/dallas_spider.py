...
from dallas.items import DallasItem

#from scrapy.shell import inspect_response

class DallasSpider(CrawlSpider):
    name = 'dallas'
    allowed_domains = ["dallas.craigslist.org"]
    start_urls = ["http://dallas.craigslist.org/search/mob?srchType=T&query=iphone"]
    base_url = "http://dallas.craigslist.org"
    rules = [
