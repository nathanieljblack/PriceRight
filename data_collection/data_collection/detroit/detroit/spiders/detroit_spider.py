...
from detroit.items import DetroitItem

#from scrapy.shell import inspect_response

class DetroitSpider(CrawlSpider):
    name = 'detroit'
    allowed_domains = ["detroit.craigslist.org"]
    start_urls = ["http://detroit.craigslist.org/search/moa?srchType=T&query=iphone"]
