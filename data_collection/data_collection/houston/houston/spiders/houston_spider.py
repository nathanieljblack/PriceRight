...
from houston.items import HoustonItem

#from scrapy.shell import inspect_response

class HoustonSpider(CrawlSpider):
    name = 'houston'
    allowed_domains = ["houston.craigslist.org"]
    start_urls = ["http://houston.craigslist.org/search/moa?srchType=T&query=iphone"]
    base_url = "http://houston.craigslist.org"
    rules = [
