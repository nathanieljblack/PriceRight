...
from lasvegas.items import LasvegasItem

#from scrapy.shell import inspect_response

class LasvegasSpider(CrawlSpider):
    name = 'lasvegas'
    allowed_domains = ["lasvegas.craigslist.org"]
    start_urls = ["http://lasvegas.craigslist.org/search/mob?srchType=T&query=iphone"]
    base_url = "http://lasvegas.craigslist.org"
    rules = [
