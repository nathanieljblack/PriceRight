...
from losangeles.items import LosangelesItem

#from scrapy.shell import inspect_response

class LosangelesSpider(CrawlSpider):
    name = 'losangeles'
    allowed_domains = ["losangeles.craigslist.org"]
    start_urls = ["http://losangeles.craigslist.org/search/mob?srchType=T&query=iphone"]
