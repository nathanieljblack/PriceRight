...
from miami.items import MiamiItem

#from scrapy.shell import inspect_response

class MiamiSpider(CrawlSpider):
    name = 'miami'
    allowed_domains = ["miami.craigslist.org"]
    start_urls = ["http://miami.craigslist.org/search/mob?srchType=T&query=iphone"]
    base_url = "http://miami.craigslist.org"
    rules = [
