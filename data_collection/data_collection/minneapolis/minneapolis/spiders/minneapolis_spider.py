...
from minneapolis.items import MinneapolisItem

#from scrapy.shell import inspect_response

class MinneapolisSpider(CrawlSpider):
    name = 'minneapolis'
    allowed_domains = ["minneapolis.craigslist.org"]
    start_urls = ["http://minneapolis.craigslist.org/search/mob?srchType=T&query=iphone"]
