...
from orangecounty.items import OrangecountyItem

#from scrapy.shell import inspect_response

class OrangecountySpider(CrawlSpider):
    name = 'orangecounty'
    allowed_domains = ["orangecounty.craigslist.org"]
    start_urls = ["http://orangecounty.craigslist.org/search/mob?srchType=T&query=iphone"]
