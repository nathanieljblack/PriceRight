...
from phoenix.items import PhoenixItem

#from scrapy.shell import inspect_response

class PhoenixSpider(CrawlSpider):
    name = 'phoenix'
    allowed_domains = ["phoenix.craigslist.org"]
    start_urls = ["http://phoenix.craigslist.org/search/mob?srchType=T&query=iphone"]
    base_url = "http://phoenix.craigslist.org"
    rules = [
