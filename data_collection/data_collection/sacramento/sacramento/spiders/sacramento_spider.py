...
from sacramento.items import SacramentoItem

#from scrapy.shell import inspect_response

class SacramentoSpider(CrawlSpider):
    name = 'sacramento'
    allowed_domains = ["sacramento.craigslist.org"]
    start_urls = ["http://sacramento.craigslist.org/search/mob?srchType=T&query=iphone"]
    base_url = "http://sacramento.craigslist.org"
    rules = [
