...
from washingtondc.items import WashingtondcItem

#from scrapy.shell import inspect_response

class WashingtondcSpider(CrawlSpider):
    name = 'washingtondc'
    allowed_domains = ["washingtondc.craigslist.org"]
    start_urls = ["http://washingtondc.craigslist.org/search/mob?srchType=T&query=iphone"]
